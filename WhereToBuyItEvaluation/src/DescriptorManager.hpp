...
public:
    ...
    static std::map<std::string, float *> loadDescriptors(const std::string& descriptorsFile, int *desc_size);
    static void destroyDescriptors(const std::map<std::string, float *>& descriptors);
    ~DescriptorManager();
